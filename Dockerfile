...
COPY etc/mediawiki/securitywiki.php /etc/securitywiki/
COPY etc/mediawiki/health.php /var/www/html
COPY etc/apache/000-securitywiki.conf /etc/apache2/sites-enabled/000-default.conf
